...
public class Test {
    public static void testAll() throws Exception {
        ...
        companyFacade.getCompanyCouponsByCompanyID(1);
        System.out.println(companyFacade.getCompanyCouponsByCompanyIDCategory(1, Coupon.Category.Food));
        System.out.println(companyFacade.getCompanyCouponsByCompanyIDPrice(1, 100.0));
