...
public class TestRepository {
	...
	public TestRepository() {
		...
		validUsers.add(new Credentials("r@a", "123", "admin"));
		validUsers.add(new Credentials("r@b", "123", "company"));
		validUsers.add(new Credentials("r@c", "123", "customer"));
...
//		}
	...
	public boolean isValidCredentials(Credentials cred) {
		return validUsers.contains(cred);
	}
}
